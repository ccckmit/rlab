...
S.Empty=create(S.no)
// 自然數集合
S.N0=S.N=create(function(e) { return S.isInteger(e)&&e>=0 })
S.N1=create(function(e) { return S.isInteger(e)&&e>=1 })
// 偶數集合
S.Even=create(function(e) { return (S.isInteger(e) && e%2===0) } )
// 奇數集合
S.Odd=create(function(e) { return (S.isInteger(e) && e%2===1) })
// 質數集合
